...
import {ROTATE_Level3} from './levels/ROTATE_Level3';
import {ROTATE_Level4} from './levels/ROTATE_Level4';
import {ROTATE_Level5} from './levels/ROTATE_Level5';
import {ROTATE_Level6} from './levels/ROTATE_Level6';
import {ROTATE_Level7} from './levels/ROTATE_Level7';
import {ROTATE_Level8} from './levels/ROTATE_Level8';
import {ROTATE_Level9} from './levels/ROTATE_Level9';
import {ROTATE_Level10} from './levels/ROTATE_Level10';
import {ROTATE_Level11} from './levels/ROTATE_Level11';
import {ROTATE_Level12} from './levels/ROTATE_Level12';
import {ROTATE_Level13} from './levels/ROTATE_Level13';
...
class ROTATE_Renderer extends ROTATE_CanvasObject {
  ...
  public renderDecals() {
    ...
    ROTATE_LevelEditorManager.level instanceof ROTATE_Level8 &&
      ROTATE_Renderer.bakeSurface.drawImage(
        ROTATE_Images.blocks,
        new Bounds(2 * a, 2 * a, a, 2 * a),
...
export class ROTATE_ScreenAwards extends ROTATE_ScreenBase {
  public rotating = !1;
...
export class ROTATE_ScreenPrimaryGame extends ROTATE_ScreenGameBase {
  ...
  public catAppear(c: number, r: number, startDir: number) {
    this.cat = new ROTATE_CatAnimationObject();
    this.cat.set_x((this.cat.x2 = (c + 0.5) * ROTATE_GameConstants.tileSize));
    this.cat.set_y((r + 1) * ROTATE_GameConstants.tileSize);
    this.cat.set_scaleX(startDir);
    this.cat.set_animation(ROTATE_CatAnimationObject.ANIM_IDLE);
    this.level.addChild(this.cat);
  }
  public catDisappear(endDir: number = 0) {
    var b = this;
    null != this.cat &&
